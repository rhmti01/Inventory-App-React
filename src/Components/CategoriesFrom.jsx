        ...
        <div className=" bg-red-400/ xx:py-4 ss:py-3 zz:px-5 ww:px-4 xx:px-3.5 ss:px-3 flex  flex-col w-full ">
          <div className="  flex flex-col  w-full bg-yellow-300/ ">
            ...
            <input
              {...register("title", {
                ...
                pattern: {
                  value: /^[A-Za-z\s]{2,15}$/,
                  message: "Only English - 2-10 letters!",
                },
              })}
              aria-invalid={errors.title ? "true" : "false"}
              className=" zz:mt-3 ww:mt-2 xx:mt-1.5 ss:mt-1 xx:text-base dd:text-[14px] ss:text-[12.5px] zz:w-52 xx:w-44 bg-transparent outline-none border-primary-500 border-2 text-stone-100  px-2 py-1.5 ss:rounded-xl  focus:border-primary-300 ring-0 "
              type="text"
            />
            {errors.title && (
          ...
          <div className=" bg-blue-400/ h-auto flex items-center justify-between w-full xx:mt-4 ss:mt-3 ">
            <button
              ...
              className=" cursor-pointer zz:text-base ww:text-[15px] xx:text-[14px] dd:text-[13px] ss:text-[12.5px] zz:py-2.5 ww:py-2 xx:py-2 ss:py-1.5 w-full py-2.5  text-main bg-primary-300 border-2 border-primary-300 hover:bg-primary-200  duration-300 hover:border-primary-200 ss:rounded-xl font-semibold  "
            >
              Add Category
            </button>
          </div>
